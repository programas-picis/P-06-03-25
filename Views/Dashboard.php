                ...
                <div class="col-xxl-8 mb-6 order-0">
                  <div class="card">
                    <div class="d-flex align-items-start row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary mb-3">¡Bienvenido a la intranet, John! 🎉</h5>                       
                          <p class="mb-6">
                          Nos alegra tenerte con nosotros. Explora todas las herramientas, recursos y novedades que hemos preparado para ti..
                          </p>
